...
```{r, echo = FALSE}
ggplot(df) +
  aes(x = Gender, y = SzOeff) +
  geom_col(fill = "#112446") +
  labs(
    x = "Geschlecht",
    y = "Nutzungsbereitschaft Szenario A (Öffentlich)",
    title = "Nutzungsbereitschaft Szenario A (Öffentlich) nach Geschlecht",
    subtitle = " ",
    caption = " "
  ) +
  theme_minimal()
...
```{r, echo= FALSE}
ggplot(df) +
  aes(x = Gender, y = SzPriv) +
  geom_col(fill = "#112446") +
  labs(
    x = "Geschlecht",
    y = "Nutzungsbereitschaft Szenario B (Privat)",
    title = "Nutzungsbereitschaft Szenario B (Privat) nach Geschlecht",
    subtitle = " ",
    caption = " "
  ) +
  theme_minimal()

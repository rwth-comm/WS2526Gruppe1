...
![Faktorenraum Neu](Faktorenraum Neu.jpg)
...
**H1:** Die Nutzungsbereitschaft von innovativen Services der Kommunalverwaltung in Szenario B (privatwirtschaftliche Zwecke) ist abhängig von Privacy-Einstellungen und Alter.  
...
```
**H2:** Die Nutzungsbereitschaft von innovativen Services der Kommunalverwaltung in Szenario A (öffentlicher Dienst Zwecke) ist abhängig von Privacy-Einstellungen und Alter. 
```{r, echo = FALSE}
jmv::linReg(data = df, 
            dep = c("SzOeff"), 
            covs = c("Priv", "Age"),

...
1. [Meet the Autor*innen](https://github.com/rwth-comm/WS2526Gruppe1?tab=readme-ov-file#poweranalysen)
...
4. [Validierte Messinstrumente](https://github.com/rwth-comm/WS2526Gruppe1?tab=readme-ov-file#validierte-messinstrumente)
...
6. [Demografie](https://github.com/rwth-comm/WS2526Gruppe1?tab=readme-ov-file#demografie)  
    1. [Demografische Daten: Gender, Alter, Bildung, Wohnort](https://github.com/rwth-comm/WS2526Gruppe1?tab=readme-ov-file#demografische-daten)
    2. [Histogramm Altersverteilung](https://github.com/rwth-comm/WS2526Gruppe1?tab=readme-ov-file#histogramm-altersverteilung)
7. [Descriptives: meet the Skalen](https://github.com/rwth-comm/WS2526Gruppe1?tab=readme-ov-file#descriptives-meet-the-skalen)
...
ggplot(df) +
  aes(x = "", y = AD) +
  geom_boxplot(fill = "#CFCFF9") +
  labs(
    x = " ",
    y = " ",
    title = "Deskriptive Darstellung des Faktors Analog / Digital (AD)",
    subtitle = "Darstellung als Boxplot",
  ...
  theme(
    ...
    plot.background  = element_rect(fill = "#F5F8FF", color = NA),
    panel.grid.major = element_line(color = "#CFCFF9"),
    panel.grid.minor = element_line(color = "#CFCFF9")
  )
...
ggplot(df) +
  ...
  labs(
    x = " ",
    y = " ",
    title = "Deskriptive Darstellung des Faktors Privacy-Einstellung (Priv)",
    subtitle = "Darstellung als Boxplot",
    caption = "Privacy-Einstellung"
  ) +
  theme_minimal() +
  theme(
    plot.title = element_text(hjust = 0.5),
...
ggplot(df) +
  ...
  labs(
    x = " ",
    y = " ",
    title = "Deskriptive Darstellung des Faktors Digital Literacy (DigLit)",
    subtitle = "Darstellung als Boxplot",
...
ggplot(df) +
  ...
  labs(
    x = " ",
    y = " ",
    title = "Deskriptive Darstellung des Faktors Nutzungsbereitschaft Szenario A (SzOeff)",
    subtitle = "Darstellung als Boxplot",
    caption = "Nutzungsbereitschaft Szenario A (öffentlicher Dienst)"
  ) +
  theme_minimal() +
  theme(
    plot.title = element_text(hjust = 0.5),
...
ggplot(df) +
  ...
  labs(
    x = " ",
    y = " ",
    title = "Deskriptive Darstellung des Faktors Nutzungsbereitschaft Szenario B (SzPriv)",
    subtitle = "Darstellung als Boxplot",
    caption = "Nutzungsbereitschaft Szenario B (privatwirtschaftliche Zwecke)"
  ) +
  theme_minimal() +
  theme(
    plot.title = element_text(hjust = 0.5),
